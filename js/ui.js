// Harta · UI helpers
import { stopReading } from "./voice.js";
...
const ICON_PATHS = {
  ...
  map: '<path d="M9 20.5 3.5 18V4.5L9 7l6-2.5 5.5 2.5V20L15 17.5 9 20.5Z"/><path d="M9 7v13.5M15 4.5V17.5"/>',
  chat: '<path d="M21 11.5a8.5 7.5 0 0 1-8.5 7.5c-1.3 0-2.5-.2-3.6-.7L4 20l1.8-3.6A7.3 7.3 0 0 1 4 11.5 8.5 7.5 0 0 1 12.5 4 8.5 7.5 0 0 1 21 11.5Z"/>',
  steth: '<path d="M5 3v5a5 5 0 0 0 10 0V3"/><path d="M10 13v3a5 5 0 0 0 10 0v-1"/><circle cx="20" cy="12.5" r="2"/>',
};
...
export function closeModal() {
  stopReading(); // a closed window is a silent window, always
